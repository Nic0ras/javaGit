 ...
 * @author Nicollas
 */
public class TelVetor extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelVetor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
